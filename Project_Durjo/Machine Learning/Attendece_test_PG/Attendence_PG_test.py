...
path=('F:\\Earthquak project\\FaceRecognation_With_Email-main\\Attendece_test_PG\\train images')     #train image 'file' path
...
#For IP Cam
IpAddress='http://192.168.1.6:8080/video'##addtion
cap.open(IpAddress)##addtion
...
def MakeAttencence(name,unknown=False):
    with open('F:\\Earthquak project\\FaceRecognation_With_Email-main\\Attendece_test_PG\\Attendence.csv', 'r+') as f:
